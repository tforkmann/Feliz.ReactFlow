...
type ReactFlow =
    ...
    static member inline onNodesRemove(handler: Node [] -> unit) : IReactFlowProp = !!("onNodesRemove" ==> handler)

    static member inline onNodesChange(handler: Node [] -> unit) : IReactFlowProp = !!("onNodesChange" ==> handler)

    static member inline onEdgesChange(handler: Edge [] -> unit) : IReactFlowProp = !!("onEdgesChange" ==> handler)
    ...
    static member inline onEdgeUpdate(handler: Event -> Edge -> unit) : IReactFlowProp = !!("onEdgeUpdate" ==> handler)
